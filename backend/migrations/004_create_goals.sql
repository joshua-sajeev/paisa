...
CREATE INDEX idx_contributions_goal
    ON contributions (goal_id);

CREATE INDEX idx_contributions_occurred_at
    ON contributions (occurred_at);
-- +goose Down

DROP INDEX idx_contributions_occurred_at;
DROP INDEX idx_contributions_goal;

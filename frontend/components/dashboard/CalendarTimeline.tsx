...
export default function CalendarTimeline() {
  ...
  return (
    <div className="w-full relative" ref={containerRef}>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-1 md:gap-2 bg-gray-50/80 border border-gray-100 p-1 rounded-xl">
            ...
            <button
              ...
              className="w-7 h-7 flex items-center justify-center cursor-pointer active:scale-95 transition-all"
            >
              <svg
                className="w-4 h-4"
                fill="none"
      ...
      {isExpanded && (
        <div className="absolute top-0 left-0 w-full z-30 shadow-xl rounded-[22px] overflow-hidden bg-white">
          <CalendarExpanded
